...
test('Bucket', (t) => {
    ...
    t.test('add features', (t) => {
        ...
        const paintVertex = bucket.arrays.paintVertexArrays.layerid;
    ...
    t.test('add features, multiple layers', (t) => {
        ...
        const a0 = bucket.arrays.paintVertexArrays.one.get(0);
        const b0 = bucket.arrays.paintVertexArrays.two.get(0);
        t.equal(a0.a_map, 17);
        t.equal(b0.a_map, 17);
        t.equal(v0.a_box0, 34);
        t.equal(v0.a_box1, 84);
    ...
    t.test('add features, disabled attribute', (t) => {
        ...
        t.deepEqual(
            bucket.arrays.paintVertexArrays.one.programConfiguration.uniforms[0].getValue.call(bucket),
            [5]
        );
    ...
    t.test('serialize', (t) => {
        ...
        t.equal(bucket.arrays.paintVertexArrays.layerid.arrayBuffer, transferables[3]);
